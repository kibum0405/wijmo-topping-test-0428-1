...
<script>
    import Employee from '../components/EmployeeBase.vue'
    ...
    export default {
        ...
        methods: {
            async init() {
                ...
                let DepartmentClass = Vue.extend(DepartmentBase);
                me.departmentId = new DepartmentClass();
                let RankClass = Vue.extend(RankBase);
                me.rankId = new RankClass();

                let Promises = lists.map(async function (value) {
                    value.departmentId = await me.departmentId.DepartmentToName(value.departmentId.id);
                    value.rankId = await me.rankId.RankToName(value.rankId.id);
                });
