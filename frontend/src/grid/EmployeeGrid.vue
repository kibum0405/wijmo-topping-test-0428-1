<template>
    <div class="container-fluid">
        <EmployeeViewViewQuery @search="search"></EmployeeViewViewQuery>
        <div class="row">
            <!-- export to Excel -->
        ...
        >
            <wj-flex-grid-filter :filterColumns="['id','userId','userName','departmentId','rankId',]" />
            <wj-flex-grid-column binding="id" header="id" width="2*" :isReadOnly="true" />
            <wj-flex-grid-column binding="userId" header="userId" width="2*" :isReadOnly="true" />
            <wj-flex-grid-column binding="userName" header="userName" width="2*" :isReadOnly="true" />
            <wj-flex-grid-column binding="departmentId" header="departmentId" width="2*" :isReadOnly="true" />
            <wj-flex-grid-column binding="rankId" header="rankId" width="2*" :isReadOnly="true" />
        </wj-flex-grid>
