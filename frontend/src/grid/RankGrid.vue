<template>
    <div class="container-fluid">
        <RankViewViewQuery @search="search"></RankViewViewQuery>
        <div class="row">
            <!-- export to Excel -->
        ...
        >
            <wj-flex-grid-filter :filterColumns="['id','rank',]" />
            <wj-flex-grid-column binding="id" header="id" width="2*" :isReadOnly="true" />
            <wj-flex-grid-column binding="rank" header="rank" width="2*" :isReadOnly="true" />
        </wj-flex-grid>
